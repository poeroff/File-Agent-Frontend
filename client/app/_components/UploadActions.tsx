...
import { CloudUpload, FolderPlus, FolderUp, type LucideIcon } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        title="파일 업로드"
        className="group relative flex h-11 items-center justify-center gap-2 overflow-hidden rounded-xl bg-jade text-sm font-semibold text-white shadow-[inset_0_1px_0_#ffffff33,0_1px_2px_#00000040] transition hover:bg-jade-strong focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-jade active:translate-y-px"
      >
...
function GhostAction({
  ...
  return (
    <button
      onClick={onClick}
      title={label}
      className="flex h-9 items-center justify-center gap-1.5 rounded-lg border border-chrome-line bg-chrome-hover/60 text-xs font-medium text-chrome-text/85 transition hover:bg-chrome-fill hover:text-chrome-text focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-jade"
    >
